...
class ClauseEnhancer(tf.keras.layers.Layer):
    ...
    def __init__(self, available_predicates, clause_string, initial_weight_value):
        ...
        :param initial_weight_value: the initial sign to the clause weight. Used if the clause weight is learned
        """
    ...
    def build(self, input_shape):
        ...
        self.clause_weight = self.add_variable(
                name='kernel',
                shape=(1,1),
